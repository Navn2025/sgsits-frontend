    ...
    <div className="space-y-6">
      ...
      <div className="p-6 bg-[#f7f8fa] rounded-md border border-slate-200 space-y-4">
        <p className="text-sm text-slate-600 leading-relaxed">
          Welcome to the <strong>Admin News</strong> portal. This content area serves as the direct migration interface for dynamic articles, downloadable schemes, syllabus sheets, and administrative records.
        </p>
